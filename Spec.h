...
class Spec : public juce::Component, private juce::Timer
{
public:
	Spec() : forwardFFT(fftOrder), spectrogramImage(juce::Image::RGB, 512, 512, true)
	{
		setOpaque(true);
		startTimerHz(60);
		setSize(700, 500);
...
private:
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(Spec)
